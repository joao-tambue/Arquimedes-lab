...
export default function ResultsCard({ input }) {
  ...
  useEffect(() => {
    const timeout = setTimeout(() => setShow(true), 100); // pequeno delay para iniciar a animação
  ...
  return (
    <div
      className={`bg-white p-6 rounded-md shadow max-w-xl mx-auto space-y-4 mt-6 w-full transform transition-all duration-700 ease-out
